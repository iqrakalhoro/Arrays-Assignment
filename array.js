...
let deleteFruit = ["apple", "banana", "mango", "orange"];
deleteFruit.pop();
...
let deleteFirstFruit = ["apple", "banana", "mango", "orange"];
...
let addFirstFruit = ["apple", "banana", "mango", "orange"];
